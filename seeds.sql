...
INSERT INTO Foods
(foodName, measurment, unitOfMeasurment, calorieAmount)
VALUES
("Banana", 1, "md", 110),
("Avocado", 1, "md", 160),
...
("Lemonade", 8, "oz", 120),
("Pepsi", 20, "oz", 210),
("BLT Sandwich", null, null, 690),
("Turkey Sandwich", null, null, 300),
("BBQ Chicken Sandwich", null, null, 260),
("Buffalo Chicken Sandwich", null, null, 480),
("BLT Sandwich", null, null, 690),
("Dirty Rice", 1, "cup", 201),
("Jasmine Rice", 1, "cup", 480),
("Wild Rice", 1, "cup", 142),
("Caramel Rice Cake", 1, null, 50),
("Blueberry Protein Muffin", 1, null, 117),
